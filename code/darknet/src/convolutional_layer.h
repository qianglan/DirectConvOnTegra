...
void forward_convolutional_layer_gpu(convolutional_layer layer, network_state state,int ln);
void forward_convolutional_layer_gpu_pre(convolutional_layer layer, network_state state);
